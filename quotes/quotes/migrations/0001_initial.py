...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('quotes_quote', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='quotes', null=True, to=orm['auth.User'])),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(related_name='quotes', to=orm['quotes.Author'])),
