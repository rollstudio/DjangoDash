...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('quotes_quote', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['quotes.Author']))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Quote.author'
        raise RuntimeError("Cannot reverse this migration. 'Quote.author' and its values cannot be restored.")
